        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-white font-semibold text-lg">Alaap Banerjee</span>
            </div>
            <p className="text-sm leading-relaxed">
              Frontend-focused Full Stack Developer passionate about creating 
              impactful solutions and optimizing user experiences.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="#hero" className="hover:text-green-400 transition-colors duration-300">
                  Home
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#portfolio" className="hover:text-green-400 transition-colors duration-300">
                  Portfolio
                </a>
              </li>
              <li>
